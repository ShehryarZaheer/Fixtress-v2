...
public class Question8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.conscientiousness_question_8,container,false);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Constant.conscientiousnessAnswersList.add(7,"0");//reversed
                Constant.NUM_OF_ATTEMPTED_QUESTIONS +=1;


                String q9 = "you often refuse to do my duties?";

                // Startinng an Fragment in question_container
                com.example.ehsanullah.loginandregistration.conscientiousness.Question9 question = new com.example.ehsanullah.loginandregistration.conscientiousness.Question9(q9);
        ...
        btnNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Constant.conscientiousnessAnswersList.add(7,"1");//reversed
                Constant.NUM_OF_ATTEMPTED_QUESTIONS +=1;
