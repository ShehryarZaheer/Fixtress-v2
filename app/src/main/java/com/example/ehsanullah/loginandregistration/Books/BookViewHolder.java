...
import com.example.ehsanullah.loginandregistration.activities.BookInfoActivity;
...
public class BookViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public BookViewHolder(Context context,View itemView) {
        super(itemView);
        this.context = context;
        imageView = (ImageView) itemView.findViewById(R.id.book_image_view);
    ...
    public void onClick(View v) {
        ...
        if (volumeInfo != null) {
            ...
            Log.i("book url",volumeInfo.getPreviewLink());
            if (volumeInfo.getPreviewLink() != null) {
                metadata.putString(BookMetadata.PREVIEW_LINK, volumeInfo.getPreviewLink());
            }
        ...
        // region Adding books search data in sharedprefs for finding related results next time
        String data = context.getSharedPreferences("books",0).getString("booksList","");
        SharedPreferences preferences = context.getSharedPreferences("books",0);
        SharedPreferences.Editor editor = preferences.edit();
        String newData = data.concat(":"+volumeInfo.getTitle());
        editor.putString("booksList",newData);
        editor.commit();
